...
const processSteps = [
  ...
  { icon: FileText, step: "02", title: "Site Assessment", description: "Our technical team conducts an on-site evaluation to understand project scope." },
  { icon: ClipboardCheck, step: "03", title: "Proposal & Quote", description: "Receive a detailed proposal with transparent pricing and project timeline." },
  { icon: Cog, step: "04", title: "Project Execution", description: "Our experienced team delivers your project with quality and efficiency." },
];

const serviceDetails = [
  { title: "Bulk Transport Logistics", features: ["Mining-focused bulk transportation", "Side tippers (34-ton, 40-ton)", "Reliable scheduled haulage", "Compliant operations", "Materials transport", "Mine-to-plant logistics"] },
  { title: "Construction Services", features: ["Civil Engineering", "General Building", "Roadworks (asphalt-focused)", "Site preparation", "Stormwater drainage systems", "Infrastructure development"] },
  { title: "Plant & Equipment Hire", features: ["TLBs", "Excavators", "Rollers", "Compactors", "Water bowsers", "Graders"] },
  { title: "Executive Shuttles", features: ["22-seater mine-compliant buses", "Executive transport", "Crew transportation", "Corporate shuttles", "Staff transportation", "Daily shift transport"] },
  { title: "Technical Support Consulting", features: ["Project advisory", "Infrastructure support", "Logistics support", "On-site planning"] },
];
...
const ServicesPage = () => {
  return (
    <div className="min-h-screen">
      ...
      <Header />
      <main>
        <PageHeader badge="Our Services" title="Comprehensive Construction Solutions" subtitle="We serve public and private sector clients with a full suite of services that meet technical, regulatory, and logistical demands." />
          ...
          <div className="container-custom">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="group relative overflow-hidden rounded-xl shadow-lg">
                <img src={asphaltPaving} alt="Asphalt paving crew at work" className="w-full h-64 object-cover group-hover:scale-105 transition-transform duration-500" />
                <div className="absolute inset-0 bg-gradient-to-t from-primary/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                  <div><h3 className="text-primary-foreground font-bold">Asphalt Paving</h3><p className="text-primary-foreground/80 text-sm">Road surfacing works</p></div>
                </div>
              </div>
              <div className="group relative overflow-hidden rounded-xl shadow-lg">
          ...
          <div className="container-custom">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {serviceDetails.map((service) => (
                <div key={service.title} className="bg-card p-8 rounded-xl border border-border shadow-md hover:shadow-lg transition-shadow">
        ...
        <section className="section-padding bg-secondary">
          <div className="container-custom">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground mt-4 max-w-2xl mx-auto">From initial consultation to project completion, we follow a structured approach to ensure success.</p>
            </div>
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {processSteps.map((step) => (
                <div key={step.step} className="bg-card p-6 rounded-xl border border-border shadow-md text-center relative hover:shadow-lg transition-shadow">
                  <span className="absolute -top-3 -right-3 w-10 h-10 rounded-full bg-accent text-accent-foreground font-bold flex items-center justify-center text-sm">{step.step}</span>
          ...
          <div className="container-custom">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-muted-foreground mb-8">Our expertise spans multiple industries, delivering specialized solutions tailored to each sector's unique requirements.</p>
              ...
              <div className="bg-card p-8 rounded-2xl border border-border shadow-lg">
                ...
                <p className="text-muted-foreground mb-6">We understand that every project is unique. Contact us to discuss your specific requirements and receive a tailored proposal.</p>
                <div className="space-y-4">
                  ...
                  <Button variant="outline" size="xl" className="w-full" asChild>
                    <a href="tel:0861555058"><Phone className="mr-2 h-5 w-5" />0861-555-058</a>
                  </Button>
                </div>
              </div>
            </div>
        ...
        <section className="section-padding bg-accent">
          <div className="container-custom text-center">
            ...
            <p className="text-accent-foreground/90 text-lg max-w-2xl mx-auto mb-8">Let's discuss how our services can support your next project.</p>

        ...
        {showFull && (
          <div className="grid md:grid-cols-2 gap-8 mt-16">
            <div className="bg-card p-8 rounded-xl shadow-md border border-border">
              ...
              <p className="text-muted-foreground leading-relaxed">
                To be Africa's most trusted and responsive infrastructure and logistics partner — 
                distinguished by our ability to deliver prompt, quality service supported by hands-on 
                expertise. We envision a future where communities are uplifted, industries operate 
                more efficiently, and clients experience a level of dependability and advisory 
                support that only a deeply rooted, family-built business like STE can provide.
              </p>
            </div>
            <div className="bg-card p-8 rounded-xl shadow-md border border-border">
              <div className="flex items-center gap-3 mb-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Our mission is to deliver high-standard civil engineering, plant hire, logistics, 
                and executive passenger services with precision, safety, and reliability at the core. 
                We combine a well-maintained, mine-compliant fleet with on-site technical advisory 
                to help clients optimize time, reduce operational costs, and achieve project success 
